...
export const environment = {
  production: false,
  areaURL: 'https://clinica-monomonkeys.herokuapp.com/area/',
  authURL: 'https://clinica-monomonkeys.herokuapp.com/auth/',
  pacienteURL: 'https://clinica-monomonkeys.herokuapp.com/paciente/',
